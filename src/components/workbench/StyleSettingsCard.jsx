...
import { Box, Heading, StylesProvider, RadioGroup, Stack, Radio } from "@chakra-ui/react";

export default function StyleSettingsCard({ styleSelected, onStyleChange, onOrientationChange, orientationSelected }) {
    return (
        <Box>
        ...
        <Box>
            ...
            <RadioGroup name="style-radio" onChange={onStyleChange} value={styleSelected}>
